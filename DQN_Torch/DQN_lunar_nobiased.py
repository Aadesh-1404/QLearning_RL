...
class DQN_Network(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        self.fc4 = nn.Linear(64, action_size, bias=False)
...
plt.ylabel('Score')
plt.xlabel('Episode #')
plt.savefig("Dqn_lunar_torch_bias_none.png")
plt.show()
...
#         env, path="video_bias10/{}.mp4".format(env_name))
#     agent.dqnetwork_local.load_state_dict(torch.load('checkpoint.pth'))
